...
import { markConsultationAsConsulted } from "@/lib/consultation-workflow";
...
export async function PATCH(
  ...
  try {
    ...
    const data = await markConsultationAsConsulted(
    ...
    console.error("[CONSULTATIONS_CONSULTED_PATCH]", error);
